...
def cutmix(x , y , alpha):
    ...
    return x, x[rand_index, :], mixed_x , y_a, y_b, lam
...
def progress_bar(current, total, msg=None):
    ...
    for i in range(5-int(TOTAL_BAR_LENGTH)-len(msg)-3):
        sys.stdout.write(' ')

    # Go back to the center of the bar.
    for i in range(5-int(TOTAL_BAR_LENGTH/2)):
        sys.stdout.write('\b')
...
if __name__ == "__main__":
    create_val_folder('dataset/tiny-imagenet-200')  # Call method to create validation image folders
